...
export default function Founder() {
  ...
  return (
    <section className="section-padding" style={{ background: 'var(--brand-navy)', color: '#ffffff' }}>
      <div className="container-custom">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <Reveal direction="right" distance={28} delay={0.15}>
            <div style={{ background: '#1a2e3e', borderRadius: 'var(--radius-card-lg)', padding: '2rem', border: '1px solid rgba(74,222,128,0.15)' }}>
              ...
              <div className="grid grid-cols-2 gap-3 text-center text-sm">
                {focus.map(item => (
                  <div
                    key={item.label}
                    style={{ background: 'var(--brand-navy)', borderRadius: '0.75rem', padding: '0.875rem 0.5rem', border: '1px solid rgba(74,222,128,0.1)' }}
                  >
                    <div
                      style={{
                        width: '32px',
