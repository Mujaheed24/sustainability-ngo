      ...
      <section className="section-padding" style={{ background: '#f0faf1' }}>
        <div className="container-custom" style={{ maxWidth: '720px', margin: '0 auto' }}>
          ...
          <div style={{ marginBottom: '2rem' }}>
            <h2 style={{ fontSize: '1.3rem', fontWeight: 900, color: '#1a5c2a', textAlign: 'center', marginBottom: '1.25rem' }}>Choose an Amount</h2>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      padding: '1.25rem',
                      textAlign: 'left',
                      background: active ? '#1a5c2a' : '#ffffff',
                      color: active ? '#ffffff' : '#0d1f2d',
                      cursor: 'pointer',
                  ...
                  >
                    {/* Bug 10 fixed: replaced emoji with lucide icon */}
                    <div style={{
                      display: 'inline-flex',
                      alignItems: 'center',
            ...
            {/* Custom amount */}
            <div style={{ background: '#ffffff', borderRadius: '1rem', border: '1.5px solid #e5e7eb', padding: '1.25rem', marginTop: '1rem' }}>
          ...
          {finalAmount && finalAmount >= 100 && (
            <div style={{ background: '#1a5c2a', color: '#ffffff', borderRadius: '0.875rem', padding: '1rem 1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            <h2 style={{ fontSize: '1.3rem', fontWeight: 900, color: '#1a5c2a', textAlign: 'center', marginBottom: '1rem' }}>Payment Method</h2>
            <div style={{ display: 'flex', background: '#ffffff', borderRadius: '0.875rem', overflow: 'hidden', border: '1.5px solid #e5e7eb' }}>
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    border: 'none',
                    cursor: 'pointer',
                    background: paymentMethod === method.key ? '#1a5c2a' : 'transparent',
          ...
          {/* Payment panel */}
          <div style={{ background: '#ffffff', borderRadius: '1.25rem', boxShadow: '0 4px 20px rgba(0,0,0,0.07)', padding: '2rem' }}>
            {paymentMethod === 'paystack' && (
              <div style={{ textAlign: 'center' }}>
                <div style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '64px', height: '64px', borderRadius: '50%', background: '#f0faf1', marginBottom: '1rem' }}>
                  <CreditCard style={{ width: '30px', height: '30px', color: '#1a5c2a' }} />
                </div>
                <h3 style={{ fontWeight: 900, fontSize: '1.2rem', color: '#0d1f2d', marginBottom: '0.5rem' }}>Pay with Paystack</h3>
                ...
                <button onClick={handlePaystack} className="btn-primary" style={{ fontSize: '1rem' }}>
            ...
            {paymentMethod === 'flutterwave' && (
              <div style={{ textAlign: 'center' }}>
                ...
                <h3 style={{ fontWeight: 900, fontSize: '1.2rem', color: '#0d1f2d', marginBottom: '0.5rem' }}>Pay with Flutterwave</h3>
                <p style={{ color: '#6b7280', marginBottom: '1.5rem', lineHeight: 1.65, fontSize: '0.9rem' }}>
                  Pan-African payment gateway. Supports cards, mobile money, M-Pesa, and more across Africa.
                </p>
                <button onClick={handleFlutterwave} style={{ background: '#ff5f00', color: '#ffffff', fontWeight: 700, fontSize: '1rem', padding: '0.875rem 2rem', borderRadius: '999px', border: 'none', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '8px', transition: 'background 0.15s' }}>
            ...
            {paymentMethod === 'bank' && (
              <div>
                <h3 style={{ fontWeight: 900, fontSize: '1.2rem', color: '#0d1f2d', textAlign: 'center', marginBottom: '1.25rem' }}>Bank Transfer Details</h3>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  {[
                    ...
                    <div key={label} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: '#f0faf1', borderRadius: '0.75rem', padding: '0.875rem 1rem', gap: '1rem' }}>
                      <div>
                        <p style={{ fontSize: '0.72rem', color: '#9ca3af', fontWeight: 600, margin: '0 0 2px' }}>{label}</p>
                        <p style={{ color: '#0d1f2d', fontWeight: 700, margin: 0, fontSize: '0.9rem', wordBreak: 'break-word' }}>{value}</p>
                      </div>
                      <button onClick={() => handleCopy(key, value)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#1a5c2a', fontSize: '0.78rem', fontWeight: 700, flexShrink: 0 }}>
                ...
                <p style={{ fontSize: '0.82rem', color: '#6b7280', marginTop: '1rem', textAlign: 'center', lineHeight: 1.65 }}>
                  ...
                  <a href="mailto:info@swwre.org" style={{ color: '#1a5c2a', fontWeight: 600 }}>info@swwre.org</a>
          ...
          {/* Trust signals — Bug 10 fixed: replaced flag/globe emojis with lucide icons */}
          <div style={{ display: 'grid', gap: '1rem', marginTop: '2.5rem' }} className="trust-grid">
            {[
              ...
              { Icon: Globe, iconColor: '#1a5c2a', iconBg: '#f0faf1', title: 'Africa-Focused', desc: 'Programs designed for African environmental realities' },
              ...
              <div key={item.title} style={{ background: '#ffffff', borderRadius: '1rem', padding: '1.25rem', textAlign: 'center', boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }}>
                ...
                <div style={{ fontWeight: 700, color: '#1a5c2a', marginBottom: '4px', fontSize: '0.9rem' }}>{item.title}</div>
